 ...
 */
const e=globalThis,s=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,i=Symbol(),r=new WeakMap;let o=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==i)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(s&&void 0===t){const s=void 0!==e&&1===e.length;s&&(t=r.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&r.set(e,t))}return t}toString(){return this.cssText}};const n=(t,...e)=>{const s=1===t.length?t[0]:e.reduce((e,s,i)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[i+1],t[0]);return new o(s,t,i)},a=s?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return(t=>new o("string"==typeof t?t:t+"",void 0,i))(e)})(t):t,{is:l,defineProperty:c,getOwnPropertyDescriptor:h,getOwnPropertyNames:d,getOwnPropertySymbols:u,getPrototypeOf:p}=Object,_=globalThis,f=_.trustedTypes,g=f?f.emptyScript:"",y=_.reactiveElementPolyfillSupport,$=(t,e)=>t,m={toAttribute(t,e){switch(e){case Boolean:t=t?g:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=null!==t;break;case Number:s=null===t?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch(t){s=null}}return s}},v=(t,e)=>!l(t,e),w={attribute:!0,type:String,converter:m,reflect:!1,useDefault:!1,hasChanged:v};
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const dt={attribute:!0,type:String,converter:m,reflect:!1,hasChanged:v},ut=(t=dt,e,s)=>{const{kind:i,metadata:r}=s;let o=globalThis.litPropertyMetadata.get(r);if(void 0===o&&globalThis.litPropertyMetadata.set(r,o=new Map),"setter"===i&&((t=Object.create(t)).wrapped=!0),o.set(s.name,t),"accessor"===i){const{name:i}=s;return{set(s){const r=e.get.call(this);e.set.call(this,s),this.requestUpdate(i,r,t,!0,s)},init(e){return void 0!==e&&this.C(i,void 0,t,e),e}}}if("setter"===i){const{name:i}=s;return function(s){const r=this[i];e.call(this,s),this.requestUpdate(i,r,t,!0,s)}}throw Error("Unsupported decorator location: "+i)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function _t(t){return pt({...t,state:!0,attribute:!1})}const ft="pulseline-card";function gt(t){const e=[];for(const s of t){const t=s.s??s.state;if(!t)continue;const i=parseFloat(t);if(isNaN(i))continue;let r;if(null!=s.lu)r=1e3*s.lu;else{if(!s.last_updated)continue;r=new Date(s.last_updated).getTime()}e.push({value:i,timestamp:r})}return e}function yt(t){if(0===t.length)return[];const e=[t[0]];let s=Math.round(100*t[0]);for(let i=1;i<t.length;i++){const r=Math.round(100*t[i]);r!==s&&(e.push(t[i]),s=r)}return e}async function $t(t,e,s){const i=new Date,r=new Date(i);r.setDate(r.getDate()-(s-1)),r.setHours(0,0,0,0);try{const i=(await t.callWS({type:"recorder/statistics_during_period",statistic_ids:[e],period:"day",start_time:r.toISOString(),types:["mean"]}))[e];if(i&&i.length>0){const t=new Array(s).fill(null);for(const e of i){if(null==e.mean)continue;const i=new Date(e.start).getTime()-r.getTime(),o=Math.floor(i/864e5);o>=0&&o<s&&(t[o]=e.mean)}return t}}catch{}return async function(t,e,s,i){try{const r=gt((await t.callWS({type:"history/history_during_period",start_time:i.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!1}))[e]||[]),o=new Array(s).fill(null),n=new Array(s).fill(0),a=new Array(s).fill(0);for(const t of r){const e=t.timestamp-i.getTime(),r=Math.floor(e/864e5);r>=0&&r<s&&(n[r]+=t.value,a[r]++)}for(let t=0;t<s;t++)a[t]>0&&(o[t]=n[t]/a[t]);return o}catch{return new Array(s).fill(null)}}(t,e,s,r)}const mt=[30,90,365];async function vt(t,e,s){const i=new Date;i.setDate(i.getDate()-s);return gt((await t.callWS({type:"history/history_during_period",start_time:i.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!1}))[e]||[]).map(t=>t.value)}console.info(`%c  ${ft.toUpperCase()}  %c  v0.2.0-dev.1  `,"color: white; background: #3b82f6; font-weight: bold; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #3b82f6; background: #e0e7ff; font-weight: bold; padding: 2px 6px; border-radius: 0 4px 4px 0;");const wt=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"];let bt=class extends ct{constructor(){super(...arguments),this._dailyBuckets=[],this._recentValues=[],this._lastFetchKey="",this._lastFetchTime=0,this._fetchInProgress=!1}static getStubConfig(){return{entity:"sensor.temperature"}}setConfig(t){if(!t||"object"!=typeof t)throw new Error("Invalid configuration: config must be an object");if(!t.entity||"string"!=typeof t.entity)throw new Error("Invalid configuration: 'entity' is required");if(t.display_style&&"unit"!==t.display_style&&"score"!==t.display_style)throw new Error("Invalid configuration: 'display_style' must be 'unit' or 'score'");if("score"===t.display_style&&(null==t.score_max||"number"!=typeof t.score_max))throw new Error("Invalid configuration: 'score_max' is required when display_style is 'score'");if(null!=t.value_precision&&("number"!=typeof t.value_precision||t.value_precision<0))throw new Error("Invalid configuration: 'value_precision' must be a non-negative number");if(t.supporting_row){const e=t.supporting_row.type;if("none"!==e&&"kudos"!==e&&"delta"!==e)throw new Error("Invalid configuration: supporting_row.type must be 'none', 'kudos', or 'delta'");if("kudos"===e){if(!Array.isArray(t.supporting_row.kudos_rules)||0===t.supporting_row.kudos_rules.length)throw new Error("Invalid configuration: 'kudos_rules' must be a non-empty array when type is 'kudos'");for(const e of t.supporting_row.kudos_rules){if("number"!=typeof e.min||"string"!=typeof e.label)throw new Error("Invalid configuration: each kudos rule must have 'min' (number) and 'label' (string)");if(null!=e.max&&"number"!=typeof e.max)throw new Error("Invalid configuration: kudos rule 'max' must be a number if provided")}}if("delta"===e&&(!t.footer_row||"recent_values_sparkline"!==t.footer_row.type))throw new Error("Invalid configuration: supporting_row 'delta' requires footer_row type 'recent_values_sparkline'")}if(t.footer_row){const e=t.footer_row.type;if("none"!==e&&"recent_days_sparkline"!==e&&"recent_values_sparkline"!==e&&"progress_bar"!==e)throw new Error("Invalid configuration: footer_row.type must be 'none', 'recent_days_sparkline', 'recent_values_sparkline', or 'progress_bar'");if("recent_values_sparkline"===e&&null!=t.footer_row.x_values&&("number"!=typeof t.footer_row.x_values||t.footer_row.x_values<2||t.footer_row.x_values>14))throw new Error("Invalid configuration: x_values must be a number between 2 and 14");if("progress_bar"===e&&"score"!==t.display_style)throw new Error("Invalid configuration: progress_bar footer requires display_style 'score'")}this._config=t}getCardSize(){return this._config?.footer_row&&"none"!==this._config.footer_row.type?3:2}getGridOptions(){return{columns:6,rows:this._config?.footer_row&&"none"!==this._config.footer_row.type?3:2,min_columns:3,min_rows:1}}updated(t){super.updated(t),(t.has("hass")||t.has("_config"))&&this._scheduleDataFetch()}_scheduleDataFetch(){if(!this._config||!this.hass)return;const t=this._config.footer_row;if(!t||"none"===t.type||"progress_bar"===t.type)return;const e="recent_values_sparkline"===t.type&&t.x_values||7,s=`${this._config.entity}:${t.type}:${e}`,i=Date.now();(s!==this._lastFetchKey||i-this._lastFetchTime>3e5)&&(this._fetchInProgress||(this._lastFetchKey=s,this._lastFetchTime=i,this._fetchData()))}async _fetchData(){if(this.hass&&this._config?.footer_row){this._fetchInProgress=!0;try{const t=this._config.footer_row;"recent_days_sparkline"===t.type?this._dailyBuckets=await $t(this.hass,this._config.entity,7):"recent_values_sparkline"===t.type&&(this._recentValues=await async function(t,e,s){for(const i of mt)try{const r=yt(await vt(t,e,i));if(r.length>=s||i===mt[mt.length-1])return r.slice(-s)}catch{continue}return[]}(this.hass,this._config.entity,t.x_values||7))}finally{this._fetchInProgress=!1}}}_getEntity(){if(this.hass&&this._config)return this.hass.states[this._config.entity]}_getIcon(t){return this._config.icon?this._config.icon:t?.attributes.icon?t.attributes.icon:"mdi:chart-line"}_getAccentColor(){return this._config.accent_color||"#3b82f6"}_getTitle(t){return this._config.name?this._config.name:t?.attributes.friendly_name?t.attributes.friendly_name:this._config.entity}_evaluateKudos(t,e){for(const s of e)if(t>=s.min&&(null==s.max||t<=s.max))return s.label;return null}_formatValue(t){const e=this._config.value_precision??0,s=parseFloat(t);return isNaN(s)?t:s.toFixed(e)}_renderValueRow(t){const e=this._formatValue(t.state);if("score"===(this._config.display_style||"unit"))return L`
    ...
    `}_renderSupportingRow(t){const e=this._config.supporting_row;if(!e||"none"===e.type)return K;if("kudos"===e.type&&e.kudos_rules){const s=parseFloat(t.state);if(isNaN(s))return K;const i=this._evaluateKudos(s,e.kudos_rules);return i?L`<div class="supporting-row">${i}</div>`:K}return"delta"===e.type?this._renderDelta(t):K}_renderDelta(t){if(this._recentValues.length<2)return K;const e=this._recentValues[0],s=this._recentValues[this._recentValues.length-1]-e,i=Math.abs(s),r=Math.round(10*i)/10,o="unit"===(this._config.display_style||"unit")&&t.attributes.unit_of_measurement||"",n=o?` ${o}`:"";let a;a=0===r?"mdi:minus":s>0?"mdi:arrow-up":"mdi:arrow-down";const l=0===r?"0":r%1==0?r.toString():r.toFixed(1),c=this._getAccentColor();return L`<div class="supporting-row delta">
      <div class="delta-badge" style="background: ${c}33; color: ${c};">
        <ha-icon .icon=${a}></ha-icon>
      </div>
      <span>${l}${n}</span>
    </div>`}_renderFooterRow(t,e){const s=this._config.footer_row;return s&&"none"!==s.type?"recent_days_sparkline"===s.type?this._renderSparkline(this._dailyBuckets,e,!0):"recent_values_sparkline"===s.type?this._renderSparkline(this._recentValues,e,!1):"progress_bar"===s.type?this._renderProgressBar(t,e):K:K}_renderSparkline(t,e,s){const i=[];for(let e=0;e<t.length;e++)null!=t[e]&&i.push({index:e,value:t[e]});if(i.length<2)return K;const r=Math.min(...i.map(t=>t.value)),o=Math.max(...i.map(t=>t.value)),n=o-r||1,a=t.length,l=a>1?276/(a-1):0,c=i.map(t=>({x:12+t.index*l,y:34-(t.value-r)/n*28})),h=c.map((t,e)=>`${0===e?"M":"L"}${t.x.toFixed(1)},${t.y.toFixed(1)}`).join(" "),d=c.map(t=>q`<circle cx="${t.x.toFixed(1)}" cy="${t.y.toFixed(1)}" r="${3.5}" fill="${e}" />`),u=s?56:40;let p=K;if(s){const t=new Date;p=Array.from({length:a},(s,i)=>{const r=new Date(t);r.setDate(r.getDate()-(a-1-i));const o=wt[r.getDay()],n=i===a-1;return q`
          <text
            x="${(12+i*l).toFixed(1)}"
            y="${54}"
            text-anchor="middle"
